...
/**
 * Runtime bootstrap copy of the v0.10.7 command-coordination migration.
 * A parity test keeps this SQL synchronized with the forward migration file.
 */
export const PLATFORM_JOB_COMMAND_CONTRACT_VERSION = '20260830130000-v2';

export const PLATFORM_JOB_COMMAND_SQL = String.raw`-- v0.10.7 - fail-closed, idempotent manual platform mutation coordination.
--
